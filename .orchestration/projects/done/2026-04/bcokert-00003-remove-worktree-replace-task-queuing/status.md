...
worktree_path: .orchestration/worktrees/bcokert-00003-remove-worktree-replace-task-queuing
branch: project/bcokert-00003-remove-worktree-replace-task-queuing
transitions:
  ...
  - stage: done
    ...
    note: slice 01 approved — worktree removed, archived to done/2026-04/bcokert-00003-remove-worktree-replace-task-queuing
