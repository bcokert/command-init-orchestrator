...
Save the file to `.orchestration/projects/{id}/03-briefs/{NN}-{slug}.md`. When called from `/design`, the project id and slice number are passed as context — use them directly. When called standalone, derive them from the project folder structure.
